  ...
  "components": {
    "schemas": {
      "metadata-values": {
            ...
            "entries": {
              ...
              "items": {
                ...
                "properties": {
                  ...
                  "value": {
                    "anyOf": [
                      "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.label",
                      {
                        "type": "array",
                        ...
                        "items": {
                          ...
                          "properties": {
                            ...
                            "label": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.label",
                            "annotation": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.label"
                          },
                          "required": [
                            "id"
                          ],
                      ...
                      },
                      {
                        ...
                        "properties": {
                          ...
                          "asText": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.label"
                        },
                        "required": [
                          "raw"
                        ],
        ...
        "minItems": 1,
        "$defs": {
          "language_coded_texts": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.label",
          "vocabulary_entries": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.value.anyOf[1]",
          "simple_value": "$ref:$.components.schemas.metadata-values.items.properties.entries.items.properties.value.anyOf[2]"
        },
